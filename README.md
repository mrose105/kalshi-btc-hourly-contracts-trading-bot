...
| Win rate | 57.8% |
| Avg hold | 9 min |
| Vol compression WR | **64.7%** vs 54.9% normal (~91% of P&L from compression trades) |
...
Dominant exit by P&L: `momentum_locked` (266 trades, 100% WR, +$93,202). Biggest drag: `no_stop` (256 trades, -$69,896).
