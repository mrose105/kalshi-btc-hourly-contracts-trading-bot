...
| Win rate | 47.3% |
| Avg hold | 9 min |
| Vol compression WR | **51.8%** vs 42.0% normal (69% of P&L from compression trades) |
...
Dominant exit by P&L: `momentum_locked` (499 trades, 100% WR, +$183,282). Biggest drag: `stop_loss` (570 trades, -$45,664).
